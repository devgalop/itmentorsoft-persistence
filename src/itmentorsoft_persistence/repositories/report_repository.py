...
from itmentorsoft_persistence.dto.category_report import CategorySummary
from itmentorsoft_persistence.dto.student_report import PaginatedStudentSummary
